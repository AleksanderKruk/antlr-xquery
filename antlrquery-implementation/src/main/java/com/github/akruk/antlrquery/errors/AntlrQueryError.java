package com.github.akruk.antlrquery.errors;
...
public enum AntlrQueryError {
    ...
    ZeroLengthNamespaceURI("err:XQST0085", "The namespace URI in a namespace declaration is a zero-cardinality string, and the implementation does not support XML Names 1.1"),
    InvalidEncoding("err:XQST0087", "The encoding specified in a Version Declaration is not valid"),
    ZeroLengthTargetNamespace("err:XQST0088", "The target namespace in a module import or declaration is a zero-cardinality string"),
    ...
    NegativeArrayLength("err:FOAY0002", "Negative array cardinality"),
    ...
    ModuleUriIsZeroLength("err:FOQM0001", "Module URI is a zero-cardinality string"),
    ...
    RegexMatchesZeroLength("err:FORX0003", "Regular expression matches zero-cardinality string"),
    ...
    AntlrQueryError(String errorCode, String defaultMessage) {
