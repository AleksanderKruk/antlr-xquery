...
public class ValueArithmeticOperator {
    ...
    public ValueArithmeticOperator(final AntlrQueryValueFactory valueFactory) {
    ...
    public AntlrQueryValue add(final AntlrQueryValue o1, final AntlrQueryValue o2) {
    ...
    public AntlrQueryValue subtract(final AntlrQueryValue o1, final AntlrQueryValue o2) {
        // Atomization is applied to each operand. The result of this operation is called the atomized operand.
        final List<AntlrQueryValue> atomized1 = atomizer.atomize(o1);
        final List<AntlrQueryValue> atomized2 = atomizer.atomize(o2);
    ...
    public AntlrQueryValue multiply(final AntlrQueryValue o1, final AntlrQueryValue o2) {
        // Atomization is applied to each operand. The result of this operation is called the atomized operand.
        final List<AntlrQueryValue> atomized1 = atomizer.atomize(o1);
        final List<AntlrQueryValue> atomized2 = atomizer.atomize(o2);
    ...
    public AntlrQueryValue divide(final AntlrQueryValue o1, final AntlrQueryValue o2) {
        // Atomization is applied to each operand. The result of this operation is called the atomized operand.
        final List<AntlrQueryValue> atomized1 = atomizer.atomize(o1);
        final List<AntlrQueryValue> atomized2 = atomizer.atomize(o2);
    ...
    public AntlrQueryValue unary(final AntlrQueryValue o1, final AntlrQueryValue o2) {
        // Atomization is applied to each operand. The result of this operation is called the atomized operand.
        final List<AntlrQueryValue> atomized1 = atomizer.atomize(o1);
        final List<AntlrQueryValue> atomized2 = atomizer.atomize(o2);
