...
public enum AntlrQuerySemanticError {
    ...
    // XPTY: Type Errors (Statically Detectable)
    ...
    // XQTY: Type Errors in Constructors (Statically Detectable)
    ...
    AntlrQuerySemanticError(final String errorCode, final String defaultMessage) {
