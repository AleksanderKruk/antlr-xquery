...
public class SemanticFunctionSets {
    ...
    public List<SimplifiedFunctionSpecification> FN() {
        ...
        final AntlrQuerySequenceType oneNumber = typeFactory.number(NumericRange.FULL);
        ...
        final RecordField quotient = new RecordField("quotient", new TypeOrReference.Type(oneNumber), true);
        final RecordField remainder = new RecordField("remainder", new TypeOrReference.Type(oneNumber), true);
        final var divisionResult = typeFactory.record(
            new LinkedHashMap<>(Map.of("quotient", quotient,
               "remainder", remainder))
        );
        fn.add(
            new SimplifiedFunctionSpecification(
        ...
        final ArgumentSpecification fmtNumOptions = new ArgumentSpecification(
            "options",
            typeFactory.zeroOrOne(typeFactory.itemChoice(typeFactory.itemString(), typeFactory.itemAnyMap())),
            EMPTY_SEQUENCE
        );
        fn.add(
            new SimplifiedFunctionSpecification(
        ...
        // ) as xs:string
        final AntlrQuerySequenceType stringOrNumber = typeFactory.choice(typeFactory.itemString(), typeFactory.itemNumber());
        ...
        final ArgumentSpecification substrLength = new ArgumentSpecification("cardinality", optionalNumber, new ParenthesizedExprContext(null, 0));
        fn.add(
            new SimplifiedFunctionSpecification(
        ...
        fn.add(
            ...
            List.of(cValue, cSubstr, optionalCollation),
            typeFactory.boolean_(),
            null,
            false,
            false,
        ...
        fn.add(
            ...
            List.of(swValue, swSubstring, optionalCollation),
            typeFactory.boolean_(),
            null,
            false,
            false,
        ...
        fn.add(
            ...
            List.of(sbValue, sbSubstring, optionalCollation),
            typeFactory.string(),
            null,
            false,
            false,
        ...
        fn.add(
            ...
            List.of(saValue, saSubstring, optionalCollation),
            typeFactory.string(),
            null,
            false,
            false,
        ...
        // 	as xs:string?	:= ''
        // ) as xs:string
        final AntlrQueryItemType dynamicReplacement = typeFactory.itemFunction(optionalItem, List.of(typeFactory.anyItem(), zeroOrMoreItems));
        final var replacementType = typeFactory.choice(typeFactory.itemString(), dynamicReplacement);
        ...
        final ArgumentSpecification subStart = new ArgumentSpecification("start",
            oneNumber, null);
        final ArgumentSpecification subLength = new ArgumentSpecification("cardinality",
            optionalNumber, EMPTY_SEQUENCE);
        fn.add(new SimplifiedFunctionSpecification(
        ...
        final var stringOrMap = typeFactory.zeroOrOne(typeFactory.itemChoice(typeFactory.itemString(), typeFactory.itemAnyMap()));
        ...
        final ArgumentSpecification utOptions = new ArgumentSpecification(
            "options",
            typeFactory.zeroOrOne(typeFactory.itemChoice(typeFactory.itemString(),
        ...
        final AntlrQuerySequenceType numberGenerator = switch (typeFactory.itemNamedType(new QualifiedName("fn", "random-number-generator-record"))) {
            case AntlrQueryTypeFactory.NamedItemAccessingResult.Success success -> typeFactory.one(success.type());
            case AntlrQueryTypeFactory.NamedItemAccessingResult.UnknownName _,
                 AntlrQueryTypeFactory.NamedItemAccessingResult.UnknownNamespace _ -> throw new IllegalStateException();
        };
        fn.add(
            new SimplifiedFunctionSpecification(
    ...
    public List<SimplifiedFunctionSpecification> MATH() {
        ...
        final ArgumentSpecification powY = new ArgumentSpecification("y", typeFactory.number(NumericRange.FULL), null);
        math.add(
            new SimplifiedFunctionSpecification(
        ...
        //  as xs:double
        // ) as xs:double
        final ArgumentSpecification atan2Y = new ArgumentSpecification("y", typeFactory.number(NumericRange.FULL), null);
        final ArgumentSpecification atan2X = new ArgumentSpecification("x", typeFactory.number(NumericRange.FULL), null);
        math.add(
            new SimplifiedFunctionSpecification(
    ...
    public List<SimplifiedFunctionSpecification> ARRAY() {
        ...
        array.add(
            ...
            List.of(
                ...
                new ArgumentSpecification(
                "action",
                typeFactory.zeroOrOne(typeFactory.itemFunction(zeroOrMoreItems, List.of(typeFactory.anyItem(), typeFactory.number(NumericRange.FULL)))),
                IDENTITY$1
                )
            ),
        ...
        final AntlrQueryItemType itemIntegerActionFunction = typeFactory.itemFunction(optionalBoolean, List.of(typeFactory.anyItem(), typeFactory.number(NumericRange.FULL)));
        array.add(
            new SimplifiedFunctionSpecification(
        ...
        final AntlrQueryItemType function_anyItem_zeroOrMoreItems$zeroOrMoreItems = typeFactory.itemFunction(zeroOrMoreItems, List.of(typeFactory.anyItem(), zeroOrMoreItems));
        array.add(
            new SimplifiedFunctionSpecification(
        ...
        // ) as array(*)
        final AntlrQueryItemType function_zeroOrMoreItems_number$zeroOrMoreItems = typeFactory.itemFunction(zeroOrMoreItems, List.of(zeroOrMoreItems, typeFactory.number(NumericRange.FULL)));
        array.add(
            new SimplifiedFunctionSpecification(
        ...
        array.add(
            ...
            List.of(
                ...
                new ArgumentSpecification(
                "action",
                typeFactory.one(typeFactory.itemFunction(zeroOrMoreItems, List.of(typeFactory.anyItem(), typeFactory.anyItem(), typeFactory.number(NumericRange.FULL)))),
                null
                )
            ),
            typeFactory.one(typeFactory.itemAnyArray()),
        ...
        */
        ...
        final AntlrQueryItemType integerPredicate = typeFactory.itemFunction(optionalBoolean, List.of(zeroOrMoreItems, typeFactory.number(NumericRange.FULL)));
        ...
        ArraySizeGranularAnalysis arraySizeGranularAnalysis = new ArraySizeGranularAnalysis(typeFactory);
        array.add(
            new SimplifiedFunctionSpecification(
            ...
            typeFactory.one(typeFactory.itemNumber(NumericRange.NON_NEGATIVE)),
            null, false, false, null, arraySizeGranularAnalysis
            )
        );
        ...
        // array:subarray($array as array(*), $start as xs:integer, $cardinality as xs:integer? := ()) as array(*)
        array.add(
            new SimplifiedFunctionSpecification(
    ...
    public List<SimplifiedFunctionSpecification> MAP() {
        ...
        final AntlrQuerySequenceType zeroOrMoreItems = typeFactory.zeroOrMore(typeFactory.itemAnyItem());
        final ArgumentSpecification mbOptions = new ArgumentSpecification(
            "options",
            typeFactory.zeroOrOne(typeFactory.itemAnyMap()),
            EMPTY_MAP
        );
        ...
        final AntlrQueryItemType mapTransformer = typeFactory.itemFunction(zeroOrMoreItems, List.of(typeFactory.anyItem(), typeFactory.number(NumericRange.FULL)));
        ...
        final AntlrQueryItemType predicate = typeFactory.itemFunction(optionalBoolean, List.of(typeFactory.anyItem(), zeroOrMoreItems));
        ...
        final ArgumentSpecification opInput = new ArgumentSpecification(
            ...
            typeFactory.zeroOrMore(
                typeFactory.guaranteedItemNamedType(
                    new QualifiedName("fn", "key-value-pair"), new IllegalStateException()
                )
            ),
            null
        );
        ...
        map.add(
            ...
            typeFactory.one(typeFactory.guaranteedItemNamedType(new QualifiedName("fn", "key-value-pair"), new IllegalStateException())),
            null, false, false, null, null
            )
        );
        ...
        map.add(
            ...
            typeFactory.zeroOrMore(
                typeFactory.guaranteedItemNamedType(new QualifiedName("fn", "key-value-pair"), new IllegalStateException())
            ),
            null, false, false, null, null
            )
        );
