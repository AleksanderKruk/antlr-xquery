...
public class ValueComparisonOperator {
    ...
    public ValueComparisonOperator(final XQueryValueFactory valueFactory) {
    ...
    private XQueryValue validateOperand(final XQueryValue operand, final List<XQueryValue> atomized) {
        ...
        if (atomized.size() > 1) {
            return valueFactory.error(XQueryError.InvalidArgumentType, "Atomized operand" + operand +" is a sequence of cardinality greater than one");
        }
        if (operand.isError) {
            return operand;
        }
    ...
    public XQueryValue valueEquals(final XQueryValue o1, final XQueryValue o2) {
    ...
    public XQueryValue valueUnequal(final XQueryValue o1, final XQueryValue o2) {
        // Atomization is applied to each operand. The result of this operation is called the atomized operand.
        final List<XQueryValue> atomized1 = atomizer.atomize(o1);
        final List<XQueryValue> atomized2 = atomizer.atomize(o2);
    ...
    public XQueryValue valueLessThan(final XQueryValue o1, final XQueryValue o2) {
        // Atomization is applied to each operand. The result of this operation is called the atomized operand.
        final List<XQueryValue> atomized1 = atomizer.atomize(o1);
        final List<XQueryValue> atomized2 = atomizer.atomize(o2);
    ...
    public XQueryValue valueGreaterThan(final XQueryValue o1, final XQueryValue o2) {
        // Atomization is applied to each operand. The result of this operation is called the atomized operand.
        final List<XQueryValue> atomized1 = atomizer.atomize(o1);
        final List<XQueryValue> atomized2 = atomizer.atomize(o2);
    ...
    public XQueryValue valueLessEqual(final XQueryValue o1, final XQueryValue o2) {
        // Atomization is applied to each operand. The result of this operation is called the atomized operand.
        final List<XQueryValue> atomized1 = atomizer.atomize(o1);
        final List<XQueryValue> atomized2 = atomizer.atomize(o2);
