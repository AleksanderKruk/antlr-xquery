...
import com.github.akruk.antlrxquery.typesystem.typeoperations.Types.EffectiveBooleanValueType;
...
public class XQuerySemanticSymbolManager {
    ...
    public XQuerySemanticError registerFunction(
        ...
        return registerFunction(
            ...
            false,
            body,
            (final List<UsedArg> arguments, final XQueryVisitingSemanticContext _, final ParseTree _, final XQuerySemanticContext typeCtx) -> defaultGrainedFunctionAnalysis(args, body, arguments, typeCtx)
            );
    }
    ...
    private TypeInContext defaultGrainedFunctionAnalysis(final List<ArgumentSpecification> args, final ParseTree body,
            final List<UsedArg> arguments, final XQuerySemanticContext typeCtx) {
