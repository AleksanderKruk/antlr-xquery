        ...
        permits FunctionType.ConstrainedFunction, FunctionType.AnyFunction
{
    ...
    record ConstrainedFunction(
            ...
            AntlrQuerySequenceType returnType
    ) implements com.github.akruk.antlrxquery.typesystem.types.itemtypes.FunctionType {
    }

    final class AnyFunction implements com.github.akruk.antlrxquery.typesystem.types.itemtypes.FunctionType {
