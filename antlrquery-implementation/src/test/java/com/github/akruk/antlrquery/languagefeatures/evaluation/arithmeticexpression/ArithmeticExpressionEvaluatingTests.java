package com.github.akruk.antlrquery.languagefeatures.evaluation.arithmeticexpression;
...
public class ArithmeticExpressionEvaluatingTests extends EvaluationTestsBase {
    ...
    public void multiplication() {
        String xquery = """
                    5 * 3.0
                """;
        var value = AntlrQuery.evaluateWithMockRoot(null, xquery, null,null);
