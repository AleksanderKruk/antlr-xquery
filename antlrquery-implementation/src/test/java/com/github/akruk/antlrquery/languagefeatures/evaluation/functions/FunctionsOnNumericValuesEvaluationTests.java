...
public class FunctionsOnNumericValuesEvaluationTests extends EvaluationTestsBase {
    @Test
    public void abs() {
    ...
    public void divideByZeroRaisesError() {
        assertError("divide-decimals(1, 0)", valueFactory.error(AntlrQueryError.DivisionByZero, ""));
    }
