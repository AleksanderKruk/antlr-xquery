...
public class NumericOperatorsFunctionsTests extends SemanticTestsBase {
    ...
    public void numericAdd_valid() {
        String call = "op:" + "numeric-add" + "(2, 3)";
    ...
    public void numericSub_valid() {
        String call = "op:" + "numeric-subtract" + "(2, 3)";
        assertType(call, typeFactory.number());
    }
    ...
    public void numericMul_valid() {
        String call = "op:" + "numeric-multiply" + "(2, 3)";
        assertType(call, typeFactory.number());
    }
    ...
    public void numericDiv_valid() {
        String call = "op:" + "numeric-divide" + "(2, 3)";
        assertType(call, typeFactory.number());
    }
    ...
    public void mod_valid() {
        String call = "op:" + "numeric-mod" + "(2, 3)";
        assertType(call, typeFactory.number());
    }
