...
public class ProcessingMapFunctionsTest extends SemanticTestsBase {
    ...
    public void pair_valid() {
        assertType(
                "map:pair('k', 1)",
                typeFactory.one(typeFactory.guaranteedItemNamedType(new QualifiedName("fn", "key-value-pair"), new Exception())))
        ;
    }
    ...
    public void pairs_valid() {
        assertType(
                ...
                typeFactory.zeroOrMore(
                    typeFactory.guaranteedItemNamedType(new QualifiedName("fn", "key-value-pair"), new Exception())
                ));
    }
