package com.github.akruk.antlrquery.languagefeatures.semantics.recordDeclarations;
...
//         let $last-line-cardinality := string-length(
...
//             character := $start-pos + $last-line-cardinality
//         )
//     }
// };
...
let $parameters :=
  ...
  | $literals//propertyAssignment[local:is-simple-property-assignment(.)]/singleExpression
return ()
