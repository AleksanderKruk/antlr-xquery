...
//     private Path validGrammarFile1;
//     private Path validGrammarFile2;
//     private Path validGrammarFile3;
//     private Path validTargetFile;
//     private Path validQueryFile;

//     @BeforeEach
//     void setUp() throws IOException {
//         validGrammarFile1 = tempDir.resolve("test.g4");
//         Files.writeString(validGrammarFile1, "grammar Test;");

//         validGrammarFile2 = tempDir.resolve("grammar1.g4");
//         Files.writeString(validGrammarFile2, "grammar Test;");

//         validGrammarFile3 = tempDir.resolve("grammar2.g4");
//         Files.writeString(validGrammarFile3, "grammar Test;");
...
//             "--grammars", List.of(validGrammarFile1.toString()),
...
//         Map<String, List<String>> args = Map.of(
//             "--grammars", List.of(validGrammarFile1.toAbsolutePath().toString()),
...
//         Map<String, List<String>> args = Map.of(
//             "--grammars", List.of(validGrammarFile1.toAbsolutePath().toString()),
//             "--target-files", List.of(validTargetFile.toAbsolutePath().toString()),
//             "--query", List.of("//node")
//         );
...
//     String absoluteTargetFilePath = validTargetFile.toAbsolutePath().toString();
//     @Test
//     void testValidateInput_EmptyStartingRule() {
//         Map<String, List<String>> args = Map.of(
//             "--grammars", List.of(validGrammarFile1.toAbsolutePath().toString()),
//             "--target-files", List.of(absoluteTargetFilePath),
...
//             "--target-files", List.of(validTargetFile.toAbsolutePath().toString()),
//             "--starting-rule", List.of("main"),
//             "--query-file", List.of(validQueryFile.toAbsolutePath().toString())
//         );
...
//         ValidationResult result = XQueryRunner.validateInput(args);
//         assertEquals(InputStatus.NO_QUERY, result.status());
//         assertEquals("Query file is a directory: " + directory.toAbsolutePath().toString(), result.message());
//     }
