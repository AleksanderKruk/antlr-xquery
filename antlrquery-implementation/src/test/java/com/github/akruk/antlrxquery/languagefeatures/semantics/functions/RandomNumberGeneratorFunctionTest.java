...
public class RandomNumberGeneratorFunctionTest extends SemanticTestsBase {
     ...
     */
    private AntlrQuerySequenceType expectedRngType() {
        // random-number-generator-record wrapped in a single-occurrence sequence
        return typeFactory.one(typeFactory.guaranteedItemNamedType(
            new QualifiedName("fn", "random-number-generator-record"), new Exception()
            ));
    }
