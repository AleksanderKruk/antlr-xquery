...
public interface ANTLRv4ParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ANTLRv4Parser#wildcard}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWildcard(ANTLRv4Parser.WildcardContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ANTLRv4Parser#qualifiedIdentifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitQualifiedIdentifier(ANTLRv4Parser.QualifiedIdentifierContext ctx);
}
