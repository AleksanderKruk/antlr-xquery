...
public final class XQueryError {
    ...
    public static final XQueryError UnknownFunctionName = new XQueryError("AXQY0001", "Called function that is not registered");
    public static final XQueryError TooManyArguments = new XQueryError("AXQY0002", "Tried to register a function with too many arguments");
