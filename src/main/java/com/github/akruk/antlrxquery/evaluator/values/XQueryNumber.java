...
// public class XQueryNumber extends XQueryValue<BigDecimal> {

//     public XQueryNumber(final BigDecimal n, final XQueryValue<?>Factory valueFactory) {
//         super(n, valueFactory);
//     }

//     public XQueryNumber(final int i, final XQueryValue<?>Factory valueFactory) {
