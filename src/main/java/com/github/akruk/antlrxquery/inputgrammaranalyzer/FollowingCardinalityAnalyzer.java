...
public class FollowingCardinalityAnalyzer extends ANTLRv4ParserBaseVisitor<Map<String, Map<String, XQueryCardinality>>> {
    ...
    public FollowingCardinalityAnalyzer(final Set<String> nodeNames, final ANTLRv4Parser antlrParser) {
