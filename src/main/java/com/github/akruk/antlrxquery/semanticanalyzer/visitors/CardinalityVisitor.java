    ...
    extends AntlrXqueryParserBaseVisitor<Cardinality> 
{
    ...
    public Cardinality visitSingleNumberCardinality(SingleNumberCardinalityContext ctx) {
        BigDecimal v = new BigDecimal(ctx.IntegerLiteral().getText());
