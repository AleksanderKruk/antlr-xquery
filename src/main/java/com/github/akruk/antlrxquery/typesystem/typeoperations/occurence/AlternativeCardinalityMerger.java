...
public class AlternativeCardinalityMerger
{
    ...
    public AlternativeCardinalityMerger()
    {
    ...
    private XQueryCardinality[][] getAutomaton() {
        ...
        automaton[ZERO][ONE] = XQueryCardinality.ZERO_OR_ONE;
        automaton[ZERO][ZERO_OR_ONE] = XQueryCardinality.ZERO_OR_ONE;
        automaton[ZERO][ZERO_OR_MORE] = XQueryCardinality.ZERO_OR_MORE;
        automaton[ZERO][ONE_OR_MORE] = XQueryCardinality.ZERO_OR_MORE;

        automaton[ONE][ZERO] = XQueryCardinality.ZERO_OR_ONE;
        automaton[ONE][ONE] = XQueryCardinality.ONE;
        ...
        automaton[ONE_OR_MORE][ZERO] = XQueryCardinality.ZERO_OR_MORE;
