...
public class IntersectionOccurenceMerger
{
    ...
    private XQueryOccurence[][] getAutomaton() {
        ...
        automaton[ZERO_OR_MORE][ONE] = XQueryOccurence.ZERO_OR_ONE;
        automaton[ZERO_OR_MORE][ZERO_OR_ONE] = XQueryOccurence.ZERO_OR_ONE;
        ...
        automaton[ONE_OR_MORE][ONE] = XQueryOccurence.ZERO_OR_ONE;
        automaton[ONE_OR_MORE][ZERO_OR_ONE] = XQueryOccurence.ZERO_OR_ONE;
