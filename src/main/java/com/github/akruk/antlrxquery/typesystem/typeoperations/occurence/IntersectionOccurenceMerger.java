...
public class IntersectionOccurenceMerger
{
    ...
    public IntersectionOccurenceMerger()
    {
    ...
    private XQueryCardinality[][] getAutomaton() {
        ...
        automaton[ZERO_OR_MORE][ONE] = XQueryCardinality.ZERO_OR_ONE;
        automaton[ZERO_OR_MORE][ZERO_OR_ONE] = XQueryCardinality.ZERO_OR_ONE;
        ...
        automaton[ONE_OR_MORE][ONE] = XQueryCardinality.ZERO_OR_ONE;
        automaton[ONE_OR_MORE][ZERO_OR_ONE] = XQueryCardinality.ZERO_OR_ONE;
