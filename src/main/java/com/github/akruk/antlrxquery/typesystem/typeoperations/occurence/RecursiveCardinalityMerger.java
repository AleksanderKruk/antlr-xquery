...
public class RecursiveCardinalityMerger
{
    ...
    public RecursiveCardinalityMerger()
    {
    ...
    private XQueryCardinality[][] getAutomaton() {
        ...
        automaton[ZERO][ONE] = XQueryCardinality.ONE_OR_MORE;
        automaton[ZERO][ZERO_OR_ONE] = XQueryCardinality.ZERO_OR_MORE;
        automaton[ZERO][ZERO_OR_MORE] = XQueryCardinality.ZERO_OR_MORE;
        automaton[ZERO][ONE_OR_MORE] = XQueryCardinality.ONE_OR_MORE;

        automaton[ONE][ZERO] = XQueryCardinality.ONE_OR_MORE;
        automaton[ONE][ONE] = XQueryCardinality.ONE_OR_MORE;
        automaton[ONE][ZERO_OR_ONE] = XQueryCardinality.ZERO_OR_MORE;
        automaton[ONE][ZERO_OR_MORE] = XQueryCardinality.ZERO_OR_MORE;
        automaton[ONE][ONE_OR_MORE] = XQueryCardinality.ONE_OR_MORE;

        automaton[ZERO_OR_ONE][ZERO] = XQueryCardinality.ZERO_OR_MORE;
        automaton[ZERO_OR_ONE][ONE] = XQueryCardinality.ZERO_OR_MORE;
