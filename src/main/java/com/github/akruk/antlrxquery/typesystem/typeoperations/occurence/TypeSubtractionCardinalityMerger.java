...
public class TypeSubtractionCardinalityMerger
{
    ...
    public TypeSubtractionCardinalityMerger()
    {
    ...
    private XQueryCardinality[][] getAutomaton() {
        ...
        automaton[ONE][ONE] = XQueryCardinality.ZERO;
        automaton[ONE][ZERO_OR_ONE] = XQueryCardinality.ZERO;
        automaton[ONE][ZERO_OR_MORE] = XQueryCardinality.ZERO;
        automaton[ONE][ONE_OR_MORE] = XQueryCardinality.ZERO;

        automaton[ZERO_OR_ONE][ZERO] = XQueryCardinality.ZERO_OR_ONE;
        automaton[ZERO_OR_ONE][ONE] = XQueryCardinality.ZERO;
        automaton[ZERO_OR_ONE][ZERO_OR_ONE] = XQueryCardinality.ZERO;
        automaton[ZERO_OR_ONE][ZERO_OR_MORE] = XQueryCardinality.ZERO;
        automaton[ZERO_OR_ONE][ONE_OR_MORE] = XQueryCardinality.ZERO;

        automaton[ZERO_OR_MORE][ZERO] = XQueryCardinality.ONE_OR_MORE; // 1+
        automaton[ZERO_OR_MORE][ONE] = XQueryCardinality.ZERO_OR_MORE; // 0, 2+
        automaton[ZERO_OR_MORE][ZERO_OR_ONE] = XQueryCardinality.ONE_OR_MORE; // 2+
        automaton[ZERO_OR_MORE][ZERO_OR_MORE] = XQueryCardinality.ZERO;
        automaton[ZERO_OR_MORE][ONE_OR_MORE] = XQueryCardinality.ZERO;

        automaton[ONE_OR_MORE][ZERO] = XQueryCardinality.ONE_OR_MORE; // 1+
        automaton[ONE_OR_MORE][ONE] = XQueryCardinality.ONE_OR_MORE; // 2+
        automaton[ONE_OR_MORE][ZERO_OR_ONE] = XQueryCardinality.ONE_OR_MORE; // 2+
        automaton[ONE_OR_MORE][ZERO_OR_MORE] = XQueryCardinality.ZERO;
        automaton[ONE_OR_MORE][ONE_OR_MORE] = XQueryCardinality.ZERO;
        return automaton;
    }
