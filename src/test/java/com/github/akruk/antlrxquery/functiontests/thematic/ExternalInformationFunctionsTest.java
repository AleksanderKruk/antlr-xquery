...
public class ExternalInformationFunctionsTest extends FunctionsSemanticTest {
    ...
    @Test public void unparsedTextLines_noArgs() {
        assertType(
            "fn:unparsed-text-lines()",
            typeFactory.zeroOrMore(typeFactory.itemString())
        );
    }
    @Test public void unparsedTextLines_withArgs() {
        assertType(
            "fn:unparsed-text-lines('u', 'encoding=UTF-8')",
            typeFactory.zeroOrMore(typeFactory.itemString())
        );
    }
    @Test public void unparsedTextLines_wrong() {
    ...
    @Test public void unparsedTextAvailable_minimal() {
        assertType(
            "fn:unparsed-text-available()",
            typeFactory.one(typeFactory.itemBoolean())
        );
    }
    @Test public void unparsedTextAvailable_withArgs() {
        assertType(
            "fn:unparsed-text-available('u', map{})",
            typeFactory.one(typeFactory.itemBoolean())
        );
    }
    @Test public void unparsedTextAvailable_wrong() {
    ...
    //     );
    // }
    @Test public void unparsedBinary_wrong() {
    ...
    @Test public void environmentVariable_valid() {
        assertType(
            "fn:environment-variable('PATH')",
            typeFactory.zeroOrOne(typeFactory.itemString())
        );
    }
    @Test public void environmentVariable_missing() {
        assertErrors("fn:environment-variable()");
    }
    @Test public void environmentVariable_wrongType() {
        assertErrors("fn:environment-variable(1)");
    }

    // fn:available-environment-variables() as xs:string*
    @Test public void availableEnvironmentVariables() {
        assertType(
            "fn:available-environment-variables()",
            typeFactory.zeroOrMore(typeFactory.itemString())
        );
    }
    @Test public void availableEnvironmentVariables_withArgs() {
