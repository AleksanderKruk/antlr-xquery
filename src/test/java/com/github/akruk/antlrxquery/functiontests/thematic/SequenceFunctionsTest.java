...
public class SequenceFunctionsTest extends FunctionsSemanticTest {
    ...
    @Test public void foot_defaultAndWithItems() {
        assertType("fn:foot()",
    ...
    @Test public void head_defaultAndWithItems() {
        assertType("fn:head()",
            typeFactory.zeroOrOne(typeFactory.itemAnyItem()));
    ...
    @Test public void identity_various() {
    ...
    @Test public void sequenceJoin_valid() {
        assertType("fn:sequence-join((1,'x',<a/>), ('-'))",
            typeFactory.zeroOrMore(typeFactory.itemAnyItem()));
    }
    @Test public void sequenceJoin_wrongArity() {
        assertErrors("fn:sequence-join(1)");
        assertErrors("fn:sequence-join()");
    }

    // fn:slice($input as item()*, $start? := (), $end? := (), $step? := ()) as item()*
    @Test public void slice_valid() {
        assertType("fn:slice((1,2,3), 2)",
            typeFactory.zeroOrMore(typeFactory.itemAnyItem()));
    }
    @Test public void slice_missingInput() {
        assertErrors("fn:slice()");
    }
    @Test public void slice_wrongTypes() {
