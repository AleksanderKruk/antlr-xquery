package com.github.akruk.languagefeatures.semantics.semanticfunctiontests.thematic;

import org.junit.jupiter.api.Test;

import com.github.akruk.languagefeatures.semantics.semanticfunctiontests.FunctionsSemanticTest;
...
public class FunctionsOnNumericValuesTest extends FunctionsSemanticTest {
    ...
    @Test
    void ceiling_defaultNotAllowed() {
        assertErrors("fn:ceiling()");
    }

    @Test
    void ceiling_wrongType() {
    ...
    // fn:round($value as xs:numeric?, $precision as xs:integer? := 0, $mode as
    // enum(...)? := 'half-to-ceiling') as xs:numeric?
    @Test
    void round_onlyValueUsesDefaults() {
        assertType("fn:round(1.23)",
                typeFactory.zeroOrOne(typeFactory.itemNumber()));
    }

    @Test
    void round_withPrecision() {
    ...
    @Test
    void round_missingValue() {
        assertErrors("fn:round()");
    }

    @Test
    void round_badPrecision() {
    ...
    // fn:round-half-to-even($value as xs:numeric?, $precision as xs:integer? := 0)
    // as xs:numeric?
    @Test
    void roundHalfToEven_defaultPrecision() {
        assertType("fn:round-half-to-even(2.5)",
                typeFactory.zeroOrOne(typeFactory.itemNumber()));
    }

    @Test
    void roundHalfToEven_withPrecision() {
        assertType("fn:round-half-to-even(2.512, 2)",
                typeFactory.zeroOrOne(typeFactory.itemNumber()));
    }

    @Test
    void roundHalfToEven_missingValue() {
