...
public class ProcessingBooleanFunctionsTest extends FunctionsSemanticTest {
    ...
    @Test
    public void true_noArgs_returnsBoolean()
    {
        assertType(
            "fn:true()",
    ...
    @Test
    public void true_withArgs_error()
    {
    ...
    @Test
    public void false_noArgs_returnsBoolean()
    {
        assertType(
            "fn:false()",
            typeFactory.one(typeFactory.itemBoolean()));
    ...
    @Test
    public void false_withArgs_error()
    {
    ...
    @Test
    public void booleanEqual_valid()
    {
        assertType(
    ...
    @Test
    public void booleanEqual_wrongTypes()
    {
    ...
    @Test
    public void booleanEqual_arityErrors()
    {
    ...
    @Test
    public void booleanLessThan_valid()
    {
        assertType(
    ...
    @Test
    public void booleanLessThan_wrongTypes()
    {
    ...
    @Test
    public void booleanLessThan_arityErrors()
    {
        assertErrors("op:boolean-less-than(true())");
    ...
    @Test
    public void boolean_withVariousItems()
    {
        assertType(
            "fn:boolean((0, '', false()))",
            typeFactory.one(typeFactory.itemBoolean()));
    ...
    @Test
    public void not_withOtherItems()
    {
        assertType(
            "fn:not((0, 'x'))",
            typeFactory.one(typeFactory.itemBoolean()));
